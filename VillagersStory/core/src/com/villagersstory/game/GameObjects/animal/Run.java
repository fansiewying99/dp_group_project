...
public class Run extends GameObject implements MoveBehaviour{
	...
	private int endTick=startTick+30;
    private double speed = 3;
    private int direction = rand.nextInt(4);
	
	public Run(VillagerStory game, List<Texture> moveRightTextures, 
